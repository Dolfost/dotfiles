...
badd +1 zsh/binds.zsh
badd +6 zsh/options.zsh
badd +0 zsh/completions.zsh
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 12 - ((10 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 12
...
silent! normal! zE
let &fdl = &fdl
let s:l = 13 - ((11 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 13
...
silent! normal! zE
let &fdl = &fdl
let s:l = 17 - ((15 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 17
...
silent! normal! zE
let &fdl = &fdl
let s:l = 23 - ((20 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 23
normal! 048|
tabnext
edit zsh/completions.zsh
argglobal
balt zsh/options.zsh
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
