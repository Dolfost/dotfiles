...
silent! normal! zE
let &fdl = &fdl
let s:l = 15 - ((13 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 15
...
silent! normal! zE
let &fdl = &fdl
let s:l = 51 - ((26 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 51
...
setlocal fdn=20
setlocal nofen
let s:l = 1146 - ((31 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 1146
...
silent! normal! zE
let &fdl = &fdl
let s:l = 1452 - ((9 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 1452
